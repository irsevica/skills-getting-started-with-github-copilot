...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice skills, scrimmages, and local matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Track and Field": {
        "description": "Running, jumping and throwing events with weekly meets",
    ...
    # Artistic activities
    "Drama Club": {
        "description": "Acting workshops and productions for all levels",
    ...
    "Debate Team": {
        "description": "Practice public speaking, argumentation and compete regionally",
